import type { Color, RefAngle, RefRange } from "./_utils.js"
 ...
 * @category Color Spaces
 */
export type A98RGB_Linear = Color<
	"A98RGB_Linear",
	{
		/** Red */
		r: RefRange<0, 1>
 ...
 * @category Color Spaces
 */
export type ProPhoto_Linear = Color<
	"ProPhoto_Linear",
	{
		/** Red */
		r: RefRange<0, 1>
 ...
 * @category Color Spaces
 */
export type REC2020_Linear = Color<
	"REC2020_Linear",
	{
		/** Red */
		r: RefRange<0, 1>
 ...
 * @category Color Spaces
 */
export type REC2100_Linear = Color<
	"REC2100_Linear",
	{
		/** Red */
		r: RefRange<0, 1>
 ...
 * @category Color Spaces
 */
export type XYZ_D65_Absolute = Color<
	"XYZ_D65_Absolute",
	{
		/** X */
		x: RefRange<0, 9504.7>
